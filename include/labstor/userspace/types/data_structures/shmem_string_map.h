...
inline uint32_t labstor_string_map_bucket_GetMarkedAtomicKey(struct labstor_string_map_bucket *bucket) {
    return labstor_string_map_bucket_GetAtomicKey(bucket) | null0_mark;
}
...
#include "labstor/types/data_structures/unordered_map/shmem_unordered_map_string.h"
