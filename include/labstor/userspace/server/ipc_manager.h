...
#include <labstor/types/data_structures/unordered_map_int_PerProcessIPC.h>
#include <labstor/types/data_structures/unordered_map_qid_t_qp.h>
...
private:
    ...
    labstor::ipc::unordered_map_int_PerProcessIPC pid_to_ipc_;
    labstor::ipc::unordered_map_qid_t_qp qps_by_id_;
