...
#ifdef __cplusplus
struct labstor_array_labstor_request_map_bucket : public labstor::shmem_type {
#else
...
namespace labstor::ipc {
    typedef labstor_array_labstor_request_map_bucket array_labstor_request_map_bucket;
}
uint32_t labstor_array_labstor_request_map_bucket::GetSize(uint32_t length) {
    return labstor_array_labstor_request_map_bucket_GetSize_global(length);
}
uint32_t labstor_array_labstor_request_map_bucket::GetSize() {
    return labstor_array_labstor_request_map_bucket_GetSize(this);
}
uint32_t labstor_array_labstor_request_map_bucket::GetLength() {
    return labstor_array_labstor_request_map_bucket_GetLength(this);
}
void* labstor_array_labstor_request_map_bucket::GetRegion() {
    return labstor_array_labstor_request_map_bucket_GetRegion(this);
}
void labstor_array_labstor_request_map_bucket::Init(void *region, uint32_t region_size, uint32_t length) {
    labstor_array_labstor_request_map_bucket_Init(this, region, region_size, length);
}
void labstor_array_labstor_request_map_bucket::Attach(void *region) {
