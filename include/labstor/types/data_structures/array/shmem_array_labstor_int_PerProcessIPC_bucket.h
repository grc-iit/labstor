...
struct array_labstor_int_PerProcessIPC_bucket_header {
    uint32_t length_;
};

class array_labstor_int_PerProcessIPC_bucket : private labstor_array_labstor_int_PerProcessIPC_bucket, public shmem_type {
public:
    ...
    inline void* GetRegion() { return labstor_array_labstor_int_PerProcessIPC_bucket_GetRegion(this); }
