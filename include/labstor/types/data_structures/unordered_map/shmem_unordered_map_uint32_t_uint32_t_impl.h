...
static inline bool labstor_unordered_map_uint32_t_uint32_t_AtomicSetKeyValue(struct labstor_array_labstor_uint32_t_uint32_t_bucket *arr, int i, struct labstor_uint32_t_uint32_t_bucket *bucket);
static inline bool labstor_unordered_map_uint32_t_uint32_t_AtomicGetValueByKey(struct labstor_array_labstor_uint32_t_uint32_t_bucket *arr, int i, uint32_t key, uint32_t *value);
static inline bool labstor_unordered_map_uint32_t_uint32_t_AtomicNullifyKey(struct labstor_array_labstor_uint32_t_uint32_t_bucket *arr, int i, uint32_t key);
...
static inline void labstor_unordered_map_uint32_t_uint32_t_Init(struct labstor_unordered_map_uint32_t_uint32_t *map, void *region, uint32_t region_size, uint32_t max_collisions) {
...
static inline void labstor_unordered_map_uint32_t_uint32_t_Attach(struct labstor_unordered_map_uint32_t_uint32_t *map, void *region) {
...
static inline bool labstor_unordered_map_uint32_t_uint32_t_Set(struct labstor_unordered_map_uint32_t_uint32_t *map, struct labstor_uint32_t_uint32_t_bucket *bucket) {
    void *bucket_region;
    uint32_t b;
    int i;

    bucket_region = labstor_array_labstor_uint32_t_uint32_t_bucket_GetRegion(&map->buckets_);
    b = labstor_uint32_t_uint32_t_bucket_hash(labstor_uint32_t_uint32_t_bucket_GetKey(bucket, bucket_region), bucket_region) % labstor_array_labstor_uint32_t_uint32_t_bucket_GetLength(&map->buckets_);
...
static inline bool labstor_unordered_map_uint32_t_uint32_t_Find(struct labstor_unordered_map_uint32_t_uint32_t *map, uint32_t key, uint32_t *value) {
    uint32_t b = labstor_uint32_t_uint32_t_bucket_hash(key, labstor_array_labstor_uint32_t_uint32_t_bucket_GetRegion(&map->buckets_)) % labstor_array_labstor_uint32_t_uint32_t_bucket_GetLength(&map->buckets_);
    int i;

    //Check the primary map first
    if(labstor_unordered_map_uint32_t_uint32_t_AtomicGetValueByKey(&map->buckets_, b, key, value)) { return true; }

    //Check the collisions second
    for(i = 0; i < labstor_array_labstor_uint32_t_uint32_t_bucket_GetLength(&map->overflow_); ++i) {
        if(labstor_unordered_map_uint32_t_uint32_t_AtomicGetValueByKey(&map->overflow_, i, key, value)) { return true; }
    }

    return false;
}

static inline bool labstor_unordered_map_uint32_t_uint32_t_Remove(struct labstor_unordered_map_uint32_t_uint32_t *map, uint32_t key) {
    int32_t b = labstor_uint32_t_uint32_t_bucket_hash(key, labstor_array_labstor_uint32_t_uint32_t_bucket_GetRegion(&map->buckets_)) % labstor_array_labstor_uint32_t_uint32_t_bucket_GetLength(&map->buckets_);
    int i;

    //Check the primary map first
    if(labstor_unordered_map_uint32_t_uint32_t_AtomicNullifyKey(&map->buckets_, b, key)) { return true;}

    //Check the collision set second
    for(i = 0; i < labstor_array_labstor_uint32_t_uint32_t_bucket_GetLength(&map->overflow_); ++i) {
        if(labstor_unordered_map_uint32_t_uint32_t_AtomicNullifyKey(&map->overflow_, i, key)) { return true;}
    }
...
static inline bool labstor_unordered_map_uint32_t_uint32_t_AtomicGetValueByKey(struct labstor_array_labstor_uint32_t_uint32_t_bucket *arr, int i, uint32_t key, uint32_t *value) {
    ...
    do {
        ...
        *value = labstor_uint32_t_uint32_t_bucket_GetValue(&tmp, labstor_array_labstor_uint32_t_uint32_t_bucket_GetRegion(arr));
...
class unordered_map_uint32_t_uint32_t : protected labstor_unordered_map_uint32_t_uint32_t, public shmem_type {
public:
    ...
    inline void Init(void *region, uint32_t region_size, uint32_t max_collisions) {
        labstor_unordered_map_uint32_t_uint32_t_Init(this, region, region_size, max_collisions);
    }
    inline void Attach(void *region) {
        labstor_unordered_map_uint32_t_uint32_t_Attach(this, region);
    }

    inline bool Set(struct labstor_uint32_t_uint32_t_bucket &bucket) {
        return labstor_unordered_map_uint32_t_uint32_t_Set(this, &bucket);
    }

    inline bool Find(uint32_t key, uint32_t &value) {
