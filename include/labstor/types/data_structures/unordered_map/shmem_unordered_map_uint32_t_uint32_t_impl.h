...
void labstor_unordered_map_uint32_t_uint32_t::Init(void *region, uint32_t region_size, uint32_t max_collisions) {
    labstor_unordered_map_uint32_t_uint32_t_Init(this, region, region_size, max_collisions);
}
void labstor_unordered_map_uint32_t_uint32_t::Attach(void *region) {
