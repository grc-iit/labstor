...
static inline bool labstor_unordered_map_uint32_t_request_AtomicSetKeyValue(struct labstor_array_labstor_request_map_bucket *arr, int i, struct labstor_request_map_bucket *bucket);
static inline bool labstor_unordered_map_uint32_t_request_AtomicGetValueByKey(struct labstor_array_labstor_request_map_bucket *arr, int i, uint32_t key, struct labstor_request* *value);
static inline bool labstor_unordered_map_uint32_t_request_AtomicNullifyKey(struct labstor_array_labstor_request_map_bucket *arr, int i, uint32_t key);
...
static inline bool labstor_unordered_map_uint32_t_request_Set(struct labstor_unordered_map_uint32_t_request *map, struct labstor_request_map_bucket *bucket) {
    void *bucket_region;
    uint32_t b;
    int i;
...
static inline bool labstor_unordered_map_uint32_t_request_Find(struct labstor_unordered_map_uint32_t_request *map, uint32_t key, struct labstor_request* *value) {
...
static inline bool labstor_unordered_map_uint32_t_request_Remove(struct labstor_unordered_map_uint32_t_request *map, uint32_t key) {
...
class unordered_map_uint32_t_request : protected labstor_unordered_map_uint32_t_request, public shmem_type {
public:
    ...
    inline bool Set(struct labstor_request_map_bucket &bucket) {
        return labstor_unordered_map_uint32_t_request_Set(this, &bucket);
    }

    inline bool Find(uint32_t key, struct labstor_request* &value) {
