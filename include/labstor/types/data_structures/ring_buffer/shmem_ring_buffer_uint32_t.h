...
static inline bool labstor_ring_buffer_uint32_t_TryEnqueueLock(struct labstor_ring_buffer_uint32_t *rbuf) {
    return LABSTOR_INF_LOCK_TRYLOCK(&rbuf->header_->e_lock_);
}
static inline bool labstor_ring_buffer_uint32_t_TryDequeueLock(struct labstor_ring_buffer_uint32_t *rbuf) {
    return LABSTOR_INF_LOCK_TRYLOCK(&rbuf->header_->d_lock_);
}
static inline void labstor_ring_buffer_uint32_t_AcquireEnqueueLock(struct labstor_ring_buffer_uint32_t *rbuf) {
    LABSTOR_INF_LOCK_PREAMBLE()
    LABSTOR_INF_LOCK_ACQUIRE(&rbuf->header_->e_lock_);
}
static inline void labstor_ring_buffer_uint32_t_AcquireDequeueLock(struct labstor_ring_buffer_uint32_t *rbuf) {
    LABSTOR_INF_LOCK_PREAMBLE();
    LABSTOR_INF_LOCK_ACQUIRE(&rbuf->header_->d_lock_);
}
static inline bool labstor_ring_buffer_uint32_t_AcquireTimedEnqueueLock(struct labstor_ring_buffer_uint32_t *rbuf, uint32_t max_ms) {
    LABSTOR_TIMED_LOCK_PREAMBLE();
    LABSTOR_TIMED_LOCK_ACQUIRE(&rbuf->header_->e_lock_, max_ms);
    return LABSTOR_LOCK_TIMED_OUT();
}
static inline bool labstor_ring_buffer_uint32_t_AcquireTimedDequeueLock(struct labstor_ring_buffer_uint32_t *rbuf, uint32_t max_ms) {
    LABSTOR_TIMED_LOCK_PREAMBLE();
    LABSTOR_TIMED_LOCK_ACQUIRE(&rbuf->header_->d_lock_, max_ms);
    return LABSTOR_LOCK_TIMED_OUT();
}
static inline void labstor_ring_buffer_uint32_t_ReleaseEnqueueLock(struct labstor_ring_buffer_uint32_t *rbuf) {
    LABSTOR_SPINLOCK_RELEASE(&rbuf->header_->e_lock_);
}
static inline void labstor_ring_buffer_uint32_t_ReleaseDequeueLock(struct labstor_ring_buffer_uint32_t *rbuf) {
...
bool labstor_ring_buffer_uint32_t::TryEnqueueLock() {
    return labstor_ring_buffer_uint32_t_TryEnqueueLock(this);
}
bool labstor_ring_buffer_uint32_t::TryDequeueLock() {
    return labstor_ring_buffer_uint32_t_TryDequeueLock(this);
}
void labstor_ring_buffer_uint32_t::AcquireEnqueueLock() {
    labstor_ring_buffer_uint32_t_AcquireEnqueueLock(this);
}
void labstor_ring_buffer_uint32_t::AcquireDequeueLock() {
    labstor_ring_buffer_uint32_t_AcquireDequeueLock(this);
}
bool labstor_ring_buffer_uint32_t::AcquireTimedEnqueueLock(uint32_t max_ms) {
    return labstor_ring_buffer_uint32_t_AcquireTimedEnqueueLock(this, max_ms);
}
bool labstor_ring_buffer_uint32_t::AcquireTimedDequeueLock(uint32_t max_ms) {
    return labstor_ring_buffer_uint32_t_AcquireTimedDequeueLock(this, max_ms);
}
void labstor_ring_buffer_uint32_t::ReleaseEnqueueLock() {
    labstor_ring_buffer_uint32_t_ReleaseEnqueueLock(this);
}
void labstor_ring_buffer_uint32_t::ReleaseDequeueLock() {
    labstor_ring_buffer_uint32_t_ReleaseDequeueLock(this);
}
