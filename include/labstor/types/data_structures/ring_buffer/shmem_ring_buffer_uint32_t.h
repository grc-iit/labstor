...
static inline bool labstor_ring_buffer_uint32_t_Init(struct labstor_ring_buffer_uint32_t *rbuf, void *region, uint32_t region_size, uint32_t max_depth) {
    ...
    if(max_depth > 0) {
        ...
        header_size = sizeof(struct labstor_ring_buffer_uint32_t_header) + labstor_bitmap_GetSize(max_depth);
        rbuf->header_->max_depth_ = (region_size - header_size) / sizeof(uint32_t);
    }
...
static inline bool labstor_ring_buffer_uint32_t_BusyWait(struct labstor_ring_buffer_uint32_t *rbuf, uint32_t bit) {
...
static inline bool labstor_ring_buffer_uint32_t_Dequeue(struct labstor_ring_buffer_uint32_t *rbuf, uint32_t *data) {
    ...
    if(labstor_ring_buffer_uint32_t_BusyWait(rbuf, entry)) {
