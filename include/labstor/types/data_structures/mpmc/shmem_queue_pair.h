...
#include <labstor/types/data_structures/mpmc/shmem_request_map.h>
...
//qid: [flags (10-bit)][cnt (32-bit)][ipc_id (22-bit)]
...
struct labstor_queue_pair {
    ...
    static inline uint64_t GetStreamQueuePairID(labstor::ipc::qid_t flags, uint32_t hash, uint32_t num_qps, int ipc_id);
    static inline uint64_t GetStreamQueuePairID(labstor::ipc::qid_t flags, const std::string &str, uint32_t ns_id, uint32_t num_qps, int ipc_id);
    static inline uint64_t GetStreamQueuePairOff(labstor::ipc::qid_t flags, uint32_t hash, uint32_t num_qps, int ipc_id);
    static inline uint64_t GetStreamQueuePairOff(labstor::ipc::qid_t flags, const std::string &str, uint32_t ns_id, uint32_t num_qps, int ipc_id);
#endif
};
...
static inline void labstor_queue_pair_ptr_Init(struct labstor_queue_pair_ptr *ptr, labstor_qid_t qid, void *sq_region, void *cq_region, void *base_region) {
    ...
    ptr->ipc_id = LABSTOR_GET_QP_IPC_ID(qid);
}
...
static inline void labstor_queue_pair_Init(
    ...
    labstor_unordered_map_uint32_t_request_Init(&qp->cq, base_region, cq_region, cq_size, depth, 0);
}
...
static inline bool labstor_queue_pair_CompleteReqIdTimed(struct labstor_queue_pair *qp, int req_id, struct labstor_request *msg) {
...
static inline bool labstor_queue_pair_CompleteReqInf(struct labstor_queue_pair *qp, int req_id, struct labstor_request *msg) {
...
static inline bool labstor_queue_pair_CompleteQuick(struct labstor_queue_pair *qp, struct labstor_request *rq, struct labstor_request *msg) {
    return labstor_queue_pair_CompleteReqIdTimed(qp, rq->req_id_, msg);
}
...
static inline bool labstor_queue_pair_CompleteByQtok(struct labstor_queue_pair *qp, struct labstor_qtok_t *qtok, struct labstor_request *msg) {
    return labstor_queue_pair_CompleteReqIdTimed(qp, qtok->req_id, msg);
}
...
uint64_t labstor::ipc::queue_pair::GetStreamQueuePairID(labstor::ipc::qid_t flags, uint32_t hash, uint32_t num_qps, int ipc_id) {
    uint32_t idx = hash % num_qps;
    return flags | ((idx << LABSTOR_GET_QP_IPC_ID_BITS) + ipc_id);
}
uint64_t labstor::ipc::queue_pair::GetStreamQueuePairID(labstor::ipc::qid_t flags, const std::string &str, uint32_t ns_id, uint32_t num_qps, int ipc_id) {
    uint32_t hash = 0;
    for(int i = 0; i < str.size(); ++i) {
        hash += str[i] << 4*(i%4);
    }
    hash *= ns_id;
    return GetStreamQueuePairID(flags, hash, num_qps, ipc_id);
}
uint64_t labstor::ipc::queue_pair::GetStreamQueuePairOff(labstor::ipc::qid_t flags, uint32_t hash, uint32_t num_qps, int ipc_id) {
    return GetStreamQueuePairID(flags, hash, num_qps, ipc_id) % num_qps;
}
uint64_t labstor::ipc::queue_pair::GetStreamQueuePairOff(labstor::ipc::qid_t flags, const std::string &str, uint32_t ns_id, uint32_t num_qps, int ipc_id) {
    return GetStreamQueuePairID(flags, str, ns_id, num_qps, ipc_id) % num_qps;
}
